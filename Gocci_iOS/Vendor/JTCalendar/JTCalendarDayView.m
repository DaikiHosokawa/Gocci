...
- (void)configureConstraintsForSubviews
{
    ...
    dotView.frame = CGRectMake(0, 0, sizeCircle, sizeCircle); // CGRectMake(0, 0, sizeDot, sizeDot);
    dotView.center = CGPointMake(self.frame.size.width / 2., self.frame.size.height / 2.); // CGPointMake(self.frame.size.width / 2., (self.frame.size.height / 2.) + sizeDot * 2.5);
    dotView.layer.cornerRadius = sizeCircle / 2.; // sizeDot / 2.;
}
...
- (void)reloadData
{
	...
	// !!!:dezamisystem
//	circleView.hidden = ![self.calendarManager.dataSource calendarHaveEvent:self.calendarManager date:self.date];
