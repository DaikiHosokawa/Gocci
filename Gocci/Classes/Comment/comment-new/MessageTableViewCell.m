...
- (void)configureSubviews
{
   ...
   // self.date_time.translatesAutoresizingMaskIntoConstraints = NO;
   // [self.contentView addSubview:self.date_time];
...
- (void)prepareForReuse
{
    ...
    // self.date_time.font = [UIFont systemFontOfSize:pointSize];
...
{
    if (!_date_time) {
        _date_time = [UILabel new];
        _date_time.translatesAutoresizingMaskIntoConstraints = NO;
        _date_time.backgroundColor = [UIColor clearColor];
        _date_time.userInteractionEnabled = NO;
        _date_time.numberOfLines = 0;
        _date_time.textColor = [UIColor grayColor];
        _date_time.font = [UIFont boldSystemFontOfSize:[MessageTableViewCell defaultFontSize]];
    }
    return _date_time;
}
*/
